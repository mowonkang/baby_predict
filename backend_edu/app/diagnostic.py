...
class Item:
    ...
    unit: str = ""
    reviewed: bool = False  # 전문가 검수 여부(현재 전부 예시)
...
ITEMS: list[Item] = [
    ...
    # ── 국어 ──
    Item("k_e1", "국어", "초등", "하", "'우리나라의 수도'를 바르게 쓴 것은?", ["서울", "서울시청", "한강", "부산"], 0, "어휘"),
    Item("k_e2", "국어", "초등", "중", "'병이 ___'에 알맞은 말은?", ["낫다", "낳다", "낮다", "났다"], 0, "맞춤법"),
    Item("k_m1", "국어", "중등", "중", "'되어요'의 준말로 알맞은 것은?", ["되요", "돼요", "됀요", "데요"], 1, "맞춤법"),
    # ── 과학 ──
    Item("s_e1", "과학", "초등", "하", "물이 어는 온도(섭씨)는?", ["100도", "50도", "0도", "-50도"], 2, "물질"),
    Item("s_m1", "과학", "중등", "중", "물의 화학식은?", ["CO2", "H2O", "O2", "NaCl"], 1, "물질"),
    # ── 사회 ──
    Item("o_e1", "사회", "초등", "하", "우리나라의 수도는?", ["부산", "서울", "대구", "인천"], 1, "지리"),
    Item("o_m1", "사회", "중등", "중", "삼권분립의 3권이 아닌 것은?", ["입법", "사법", "행정", "언론"], 3, "정치"),
]
