...
if not exist "app\main.py" goto nomain
...
if errorlevel 1 ( echo   - 재시도: 사용자 폴더로 설치합니다... & %PY% -m pip install -q --user -r requirements.txt )
...
echo   GitHub ZIP 을 받은 경우, 압축을 완전히 푼 폴더 안의 start.bat 을 실행하세요.
echo.
pause
exit /b 1
